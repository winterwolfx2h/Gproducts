...
public class ProductCharacteristicsController {
        ...
        try {
            ...
            for (ProductCharacteristics pCharacteristic : PCharacteristicsList) {
                if (pCharacteristic == null) {
                    return ResponseEntity.badRequest().body("Product Characteristic is missing for one or more ProductCharacteristics.");
                }
                                ...
                                List<ProductCharacteristics.CharacteristicValueDes> valueDescriptions =
                                        base.query(
                                                ...
                                                new RowMapper<ProductCharacteristics.CharacteristicValueDes>() {
                                                    @Override
                                                    public ProductCharacteristics.CharacteristicValueDes mapRow(ResultSet rs, int rowNum) throws SQLException {
                                                        ProductCharacteristics.CharacteristicValueDes valueDescription = new ProductCharacteristics.CharacteristicValueDes();
    ...
    @CacheEvict(value = "CharacteristicsCache", allEntries = true)
    public ResponseEntity<?> update(@PathVariable int pCharacteristic_code, @RequestBody ProductCharacteristics ProductCharacteristics) {
        try {
            ProductCharacteristics updatedProductChar = pCharacteristicsService.update(pCharacteristic_code, ProductCharacteristics);
