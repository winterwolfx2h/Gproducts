...
public class ProductPriceVersionController {
    ...
    public ResponseEntity<ProductPriceVersion> getProductPriceVersionById(@PathVariable("productPriceVersionCode") int productPriceVersionCode) {
        try {
    ...
    public ResponseEntity<?> updateProductPriceVersion(
        ...
        try {
            ProductPriceVersion updatedVersion = productPriceVersionService.update(productPriceVersionCode, updatedProductPriceVersion);
    ...
    public ResponseEntity<String> deleteProductPriceVersion(@PathVariable("productPriceVersionCode") int productPriceVersionCode) {
        try {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<ProductPriceVersion>> searchProductPriceVersionsByKeyword(@RequestParam("name") String name) {
        try {
