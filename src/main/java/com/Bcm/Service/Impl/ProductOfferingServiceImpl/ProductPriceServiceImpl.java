...
public class ProductPriceServiceImpl implements ProductPriceService {
    ...
    public ProductPrice update(int productPriceCode, ProductPrice updatedProductPrice) {
        ...
        if (existingProductPriceOptional.isPresent()) {
            ...
            existingProductPrice.setAmount(updatedProductPrice.getAmount());
            existingProductPrice.setPrice(updatedProductPrice.getPrice());
            existingProductPrice.setRecuringPrice(updatedProductPrice.getRecuringPrice());
    ...
    public ProductPrice findById(int productPriceCode) {
        try {
            ...
            return optionalProductPrice.orElseThrow(() -> new RuntimeException("ProductPrice with ID " + productPriceCode + " not found"));
        } catch (IllegalArgumentException e) {
