...
//            }
    ...
    public CustomerFacingServiceSpec update(int serviceId, CustomerFacingServiceSpec updatedCustomerFacingServiceSpec) {
        Optional<CustomerFacingServiceSpec> existingCustomerFacingServiceSpecOptional =
                customerFacingServiceSpecRepository.findById(serviceId);
...
//                }
    ...
    public String delete(int serviceId) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "An unexpected error occurred while deleting CustomerFacingServiceSpec with ID: " + serviceId, e);
        }
    }
    ...
    public CustomerFacingServiceSpec findById(int serviceId) {
        try {
            return customerFacingServiceSpecRepository
                    .findById(serviceId)
                    .orElseThrow(
                            () -> new ResourceNotFoundException("CustomerFacingServiceSpec  with ID " + serviceId + " not found"));
                ...
                case "Suspended":
                    throw new ServiceLogicException(
                            "CustomerFacingServiceSpec "
                                    + existingService.getServiceSpecType()
